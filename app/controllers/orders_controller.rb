class OrdersController < ApplicationController
  ...
  def create
    ...
    if @order.save
      ...
      render 'new', warning: "Something went wrong, please try again"
    end
  end
...
protected
  def order_params
    @order_params ||= params.require(:order).
      permit(credit_card_attributes: [:card_number, :expiration_date], line_items_attributes: [:product_id, :quantity])
  end
end
